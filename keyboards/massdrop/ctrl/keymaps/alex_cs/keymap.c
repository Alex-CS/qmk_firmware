...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,                              L_BRI, \
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,            L_PTP,   L_BRD,   L_PTN \
    ),
    /*
    [X] = LAYOUT(
